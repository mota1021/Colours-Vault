...
- セグメント3D分割・断面描画は **Step6/Step7** として独立化 → [[創作/ゲーム/Colours/shared/実装ログ/020_ライトが当たっている箇所が消えるオブジェクト/060_セグメント3D分割/000_概要]] / [[創作/ゲーム/Colours/shared/実装ログ/020_ライトが当たっている箇所が消えるオブジェクト/070_断面描画/000_概要]]
